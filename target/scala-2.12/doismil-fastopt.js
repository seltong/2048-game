...
/** @constructor */
function $c_Ljogo_Tabuleiro$() {
  $c_O.call(this);
  this.divisao$1 = null;
  this.corpo$1 = null;
  this.pontuacao$1 = 0;
  this.recorde$1 = 0;
  this.COR$undBLOCO$1 = null;
  this.COR$undPLANO$undDE$undFUNDO$1 = null;
  this.DIM$1 = 0;
  this.matriz$1 = null;
  this.posSomadas$1 = null
}
$c_Ljogo_Tabuleiro$.prototype = new $h_O();
$c_Ljogo_Tabuleiro$.prototype.constructor = $c_Ljogo_Tabuleiro$;
/** @constructor */
function $h_Ljogo_Tabuleiro$() {
  /*<skip>*/
}
$h_Ljogo_Tabuleiro$.prototype = $c_Ljogo_Tabuleiro$.prototype;
$c_Ljogo_Tabuleiro$.prototype.setPosicoesSomadas__I__I__V = (function(x, y) {
  this.posSomadas$1.get(x).set(y, true)
});
$c_Ljogo_Tabuleiro$.prototype.atualizarPontuacaoERecorde__V = (function() {
  var lblPontuacao = this.corpo$1.getElementById("lblPont");
  var lblRecorde = this.corpo$1.getElementById("lblRecorde");
  lblPontuacao.textContent = ("Pontua\u00e7\u00e3o: " + this.pontuacao$1);
  lblRecorde.textContent = ("Recorde: " + this.recorde$1)
});
$c_Ljogo_Tabuleiro$.prototype.soma__I__I__I__I__V = (function(x, y, toX, toY) {
  if ((this.matriz$1.get(x).get(y) === this.matriz$1.get(toX).get(toY))) {
    if ((!this.posSomadas$1.get(x).get(y))) {
      var ev$1 = this.matriz$1.get(toX);
      ev$1.set(toY, ((ev$1.get(toY) + this.matriz$1.get(x).get(y)) | 0));
      this.pontuacao$1 = ((this.pontuacao$1 + this.matriz$1.get(toX).get(toY)) | 0);
      this.matriz$1.get(x).set(y, 0);
      this.setPosicoesSomadas__I__I__V(x, y)
    }
  }
});
$c_Ljogo_Tabuleiro$.prototype.movimento$undcima__I__I__V = (function(x, y) {
  _movimento_cima: while (true) {
    if ((x <= this.DIM$1)) {
      if ((this.matriz$1.get(x).get(y) !== 0)) {
        var newPos = this.avaliar$undmovimentoX$undcima__I__I__T2((((-1) + x) | 0), y);
        var x$4 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
        if ((!((newPos !== null) && newPos.equals__O__Z(x$4)))) {
          this.matriz$1.get(newPos.$$und1$mcI$sp__I()).set(newPos.$$und2$mcI$sp__I(), this.matriz$1.get(x).get(y));
          this.matriz$1.get(x).set(y, 0)
        };
        if (((((-1) + newPos.$$und1$mcI$sp__I()) | 0) >= 0)) {
          this.soma__I__I__I__I__V(newPos.$$und1$mcI$sp__I(), newPos.$$und2$mcI$sp__I(), (((-1) + newPos.$$und1$mcI$sp__I()) | 0), newPos.$$und2$mcI$sp__I())
        }
      };
      x = ((1 + x) | 0);
      continue _movimento_cima
    };
    break
  }
});
$c_Ljogo_Tabuleiro$.prototype.init___ = (function() {
  $n_Ljogo_Tabuleiro$ = this;
  this.divisao$1 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("div");
  this.corpo$1 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument();
  this.pontuacao$1 = 0;
  this.recorde$1 = 0;
  this.COR$undBLOCO$1 = "#B0C4DE";
  this.COR$undPLANO$undDE$undFUNDO$1 = "#778899";
  this.DIM$1 = 3;
  var n1 = ((1 + this.DIM$1) | 0);
  var n2 = ((1 + this.DIM$1) | 0);
  var arr = $newArrayObject($d_I.getArrayOf().getArrayOf(), [n1]);
  var isEmpty$4 = (n1 <= 0);
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      var v1 = i;
      arr.set(v1, $newArrayObject($d_I.getArrayOf(), [n2]));
  ...
  this.matriz$1 = arr;
  var n1$1 = ((1 + this.DIM$1) | 0);
  var n2$1 = ((1 + this.DIM$1) | 0);
  var arr$1 = $newArrayObject($d_Z.getArrayOf().getArrayOf(), [n1$1]);
  var isEmpty$4$1 = (n1$1 <= 0);
  var scala$collection$immutable$Range$$lastElement$4$1 = (((-1) + n1$1) | 0);
  if ((!isEmpty$4$1)) {
    var i$1 = 0;
    while (true) {
      var v1$1 = i$1;
      arr$1.set(v1$1, $newArrayObject($d_Z.getArrayOf(), [n2$1]));
  ...
  this.posSomadas$1 = arr$1;
  return this
});
$c_Ljogo_Tabuleiro$.prototype.mensagemRecorde__Lorg_scalajs_dom_raw_Node = (function() {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var jsx$4 = this$1.div__Lscalatags_JsDom$TypedTag();
  var array = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("painelRecorde", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$3 = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var this$10 = $m_Lscalatags_JsDom$all$();
  var this$4 = $m_Lscalatags_JsDom$all$();
  var jsx$2 = this$4.label__Lscalatags_JsDom$TypedTag();
  var array$1 = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("lblRecorde", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("clslblRecorde", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$1 = jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1));
  $m_Lscalatags_JsDom$all$();
  var v = ("Recorde: " + this.recorde$1);
  var array$2 = [new $c_Lscalatags_JsDom$StringFrag().init___T(v)];
  var e = jsx$1.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2)).render__Lorg_scalajs_dom_raw_Element();
  var array$3 = [new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$10, e)];
  var cont = jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3));
  return this.corpo$1.body.appendChild(cont.render__Lorg_scalajs_dom_raw_Element())
});
$c_Ljogo_Tabuleiro$.prototype.next__I = (function() {
  var random = new $c_s_util_Random().init___();
  return ((random.self$1.nextFloat__F() < 0.75) ? 2 : 4)
});
$c_Ljogo_Tabuleiro$.prototype.mensagemFimJogo__Lorg_scalajs_dom_raw_Node = (function() {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var jsx$13 = this$1.div__Lscalatags_JsDom$TypedTag();
  var array = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("painelFimJogo", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().style__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("display:none;", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$12 = jsx$13.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var this$10 = $m_Lscalatags_JsDom$all$();
  var this$4 = $m_Lscalatags_JsDom$all$();
  var jsx$10 = this$4.label__Lscalatags_JsDom$TypedTag();
  var array$1 = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("lblFimJogo", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("clslblFimJogo", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$9 = jsx$10.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1));
  var array$2 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Fim de Jogo"))];
  var e = jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2)).render__Lorg_scalajs_dom_raw_Element();
  var jsx$11 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$10, e);
  var this$17 = $m_Lscalatags_JsDom$all$();
  var this$11 = $m_Lscalatags_JsDom$all$();
  var jsx$7 = this$11.label__Lscalatags_JsDom$TypedTag();
  var array$3 = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("lblPontuacao", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("clslblFimJogo", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$6 = jsx$7.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3));
  $m_Lscalatags_JsDom$all$();
  var v = ("Sua pontua\u00e7\u00e3o foi: " + this.pontuacao$1);
  var array$4 = [new $c_Lscalatags_JsDom$StringFrag().init___T(v)];
  var e$1 = jsx$6.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$4)).render__Lorg_scalajs_dom_raw_Element();
  var jsx$8 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$17, e$1);
  var this$24 = $m_Lscalatags_JsDom$all$();
  var this$18 = $m_Lscalatags_JsDom$all$();
  var jsx$4 = this$18.button__Lscalatags_JsDom$TypedTag();
  var array$5 = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("reiniciar", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("jogo.Tabuleiro().reiniciar()", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("clsbtnFimJogo", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$3 = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$5));
  var array$6 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Reiniciar"))];
  var e$2 = jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$6)).render__Lorg_scalajs_dom_raw_Element();
  var jsx$5 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$24, e$2);
  var this$31 = $m_Lscalatags_JsDom$all$();
  var this$25 = $m_Lscalatags_JsDom$all$();
  var jsx$2 = this$25.button__Lscalatags_JsDom$TypedTag();
  var array$7 = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("finalizar", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("jogo.Tabuleiro().finalizar()", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("clsbtnFimJogo", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$1 = jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$7));
  var array$8 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Finalizar"))];
  var e$3 = jsx$1.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$8)).render__Lorg_scalajs_dom_raw_Element();
  var array$9 = [jsx$11, jsx$8, jsx$5, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$31, e$3)];
  var container = jsx$12.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$9));
  return this.corpo$1.body.appendChild(container.render__Lorg_scalajs_dom_raw_Element())
});
$c_Ljogo_Tabuleiro$.prototype.$$js$exported$meth$reiniciar__O = (function() {
  return this.reiniciar__O()
});
$c_Ljogo_Tabuleiro$.prototype.limpar$1__p1__I__Z = (function(x) {
  _limpar: while (true) {
    var x1 = x;
    switch (x1) {
      case 4: {
      ...
      default: {
        var jsx$2 = this.posSomadas$1;
        var jsx$1 = x;
        var n1 = ((1 + this.DIM$1) | 0);
        jsx$2.set(jsx$1, $newArrayObject($d_Z.getArrayOf(), [n1]));
        x = ((1 + x) | 0);
        continue _limpar
      }
    }
...
$c_Ljogo_Tabuleiro$.prototype.avaliar$undmovimentoY$unddireita__I__I__T2 = (function(x, y) {
  if ((this.DIM$1 === y)) {
    return ((this.matriz$1.get(x).get(y) === 0) ? new $c_s_Tuple2$mcII$sp().init___I__I(x, y) : new $c_s_Tuple2$mcII$sp().init___I__I(x, (((-1) + y) | 0)))
  } else if ((this.matriz$1.get(x).get(y) === 0)) {
    var avMov = this.avaliar$undmovimentoY$unddireita__I__I__T2(x, ((1 + y) | 0));
    var x$5 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
    if ((!((avMov !== null) && avMov.equals__O__Z(x$5)))) {
      return avMov
    } else {
      return new $c_s_Tuple2$mcII$sp().init___I__I(x, y)
    }
  } else {
    return new $c_s_Tuple2$mcII$sp().init___I__I(x, (((-1) + y) | 0))
  }
});
$c_Ljogo_Tabuleiro$.prototype.tamanhoDoNumero__I__D = (function(num) {
  var thiz = ("" + num);
  return (15 - (2.5 * (((-1) + $uI(thiz.length)) | 0)))
});
$c_Ljogo_Tabuleiro$.prototype.mensagemPont__Lorg_scalajs_dom_raw_Node = (function() {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var jsx$4 = this$1.div__Lscalatags_JsDom$TypedTag();
  var array = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("painelPont", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$3 = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var this$10 = $m_Lscalatags_JsDom$all$();
  var this$4 = $m_Lscalatags_JsDom$all$();
  var jsx$2 = this$4.label__Lscalatags_JsDom$TypedTag();
  var array$1 = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("lblPont", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("clslblPont", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$1 = jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1));
  $m_Lscalatags_JsDom$all$();
  var v = ("Pontua\u00e7\u00e3o: " + this.pontuacao$1);
  var array$2 = [new $c_Lscalatags_JsDom$StringFrag().init___T(v)];
  var e = jsx$1.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2)).render__Lorg_scalajs_dom_raw_Element();
  var array$3 = [new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$10, e)];
  var cont = jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3));
...
$c_Ljogo_Tabuleiro$.prototype.movimento$undesquerda__I__I__V = (function(x, y) {
  _movimento_esquerda: while (true) {
    if ((y <= this.DIM$1)) {
      if ((this.matriz$1.get(x).get(y) !== 0)) {
        var newPos = this.avaliar$undmovimentoY$undesquerda__I__I__T2(x, (((-1) + y) | 0));
        var x$4 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
        if ((!((newPos !== null) && newPos.equals__O__Z(x$4)))) {
          this.matriz$1.get(newPos.$$und1$mcI$sp__I()).set(newPos.$$und2$mcI$sp__I(), this.matriz$1.get(x).get(y));
          this.matriz$1.get(x).set(y, 0)
        };
        if (((((-1) + newPos.$$und2$mcI$sp__I()) | 0) >= 0)) {
          this.soma__I__I__I__I__V(newPos.$$und1$mcI$sp__I(), newPos.$$und2$mcI$sp__I(), newPos.$$und1$mcI$sp__I(), (((-1) + newPos.$$und2$mcI$sp__I()) | 0))
        }
      };
      y = ((1 + y) | 0);
      continue _movimento_esquerda
    };
    break
  }
});
$c_Ljogo_Tabuleiro$.prototype.movimento__I__Z = (function(sentido) {
  var matrizAux = this.clona__AAI__AAI(this.matriz$1);
  if ((sentido === 38)) {
    this.movimento$undcima__I__I__V(1, 0);
    this.movimento$undcima__I__I__V(1, 1);
    this.movimento$undcima__I__I__V(1, 2);
    this.movimento$undcima__I__I__V(1, 3)
  } else if ((sentido === 40)) {
    this.movimento$undbaixo__I__I__V(2, 0);
    this.movimento$undbaixo__I__I__V(2, 1);
    this.movimento$undbaixo__I__I__V(2, 2);
    this.movimento$undbaixo__I__I__V(2, 3)
  } else if ((sentido === 37)) {
    this.movimento$undesquerda__I__I__V(0, 1);
    this.movimento$undesquerda__I__I__V(1, 1);
    this.movimento$undesquerda__I__I__V(2, 1);
    this.movimento$undesquerda__I__I__V(3, 1)
  } else if ((sentido === 39)) {
    this.movimento$unddireita__I__I__V(0, 2);
    this.movimento$unddireita__I__I__V(1, 2);
    this.movimento$unddireita__I__I__V(2, 2);
    this.movimento$unddireita__I__I__V(3, 2)
  };
  this.limpar$1__p1__I__Z(0);
  var matriz2 = this.matriz$1;
  return (!this.for1$3__p1__I__AAI__AAI__Z(0, matrizAux, matriz2))
});
$c_Ljogo_Tabuleiro$.prototype.preencheTab$1__p1__I__I__Lorg_scalajs_dom_raw_HTMLCollection__Z = (function(x, y, valores$1) {
  _preencheTab: while (true) {
    var x1 = x;
    switch (x1) {
      case 4: {
        return true;
      ...
      default: {
        ...
        switch (x1$2) {
          ...
          default: {
            if ((this.matriz$1.get(x).get(y) !== 0)) {
              valores$1[x].getElementsByClassName("valor")[y].textContent = ("" + this.matriz$1.get(x).get(y));
              valores$1[x].getElementsByClassName("valor")[y].style = (("font-size: " + this.tamanhoDoNumero__I__D(this.matriz$1.get(x).get(y))) + "vmin;")
            } else {
              valores$1[x].getElementsByClassName("valor")[y].textContent = "";
              valores$1[x].getElementsByClassName("bloco")[y].style = (("background-color: " + this.COR$undBLOCO$1) + ";")
            };
            this.preencheTab$1__p1__I__I__Lorg_scalajs_dom_raw_HTMLCollection__Z(x, ((1 + y) | 0), valores$1)
          }
        };
        var temp$x = ((1 + x) | 0);
        x = temp$x;
        y = 0;
        continue _preencheTab
      }
    }
  }
});
$c_Ljogo_Tabuleiro$.prototype.$$js$exported$meth$jogar__O = (function() {
  this.jogar__V()
});
$c_Ljogo_Tabuleiro$.prototype.for2$3__p1__I__AAI__AAI__I__Z = (function(j, matriz1$1, matriz2$1, i$3) {
  _for2: while (true) {
    var x1 = j;
    switch (x1) {
      default: {
        if ((x1 > this.DIM$1)) {
          return this.for1$3__p1__I__AAI__AAI__Z(((1 + i$3) | 0), matriz1$1, matriz2$1)
        } else if ((matriz1$1.get(i$3).get(j) === matriz2$1.get(i$3).get(j))) {
          j = ((1 + j) | 0);
          continue _for2
        } else {
          return false
...
$c_Ljogo_Tabuleiro$.prototype.movimento$undbaixo__I__I__V = (function(x, y) {
  _movimento_baixo: while (true) {
    if ((x >= 0)) {
      if ((this.matriz$1.get(x).get(y) !== 0)) {
        var newPos = this.avaliar$undmovimentoX$undbaixo__I__I__T2(((1 + x) | 0), y);
        var x$4 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
        if ((!((newPos !== null) && newPos.equals__O__Z(x$4)))) {
          this.matriz$1.get(newPos.$$und1$mcI$sp__I()).set(newPos.$$und2$mcI$sp__I(), this.matriz$1.get(x).get(y));
          this.matriz$1.get(x).set(y, 0)
        };
        if ((((1 + newPos.$$und1$mcI$sp__I()) | 0) <= this.DIM$1)) {
          this.soma__I__I__I__I__V(newPos.$$und1$mcI$sp__I(), newPos.$$und2$mcI$sp__I(), ((1 + newPos.$$und1$mcI$sp__I()) | 0), newPos.$$und2$mcI$sp__I())
        }
      };
      x = (((-1) + x) | 0);
      continue _movimento_baixo
    };
    break
  }
});
$c_Ljogo_Tabuleiro$.prototype.atualizarValores__I__O = (function(sentido) {
  var valores = this.corpo$1.getElementsByClassName("linhaBlocos");
  if (((((sentido === 37) || (sentido === 38)) || (sentido === 39)) || (sentido === 40))) {
    if (this.movimento__I__Z(sentido)) {
      $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(100.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, valores$1) {
        return (function() {
          var jsx$3 = $m_Ljogo_Tabuleiro$();
          var this$1 = $m_Ljogo_Tabuleiro$();
          var jsx$2 = this$1.rand__I();
          var this$2 = $m_Ljogo_Tabuleiro$();
          var jsx$1 = this$2.rand__I();
          var this$3 = $m_Ljogo_Tabuleiro$();
          jsx$3.addProx__I__I__I__V(jsx$2, jsx$1, this$3.next__I());
          $this.preencheTab$1__p1__I__I__Lorg_scalajs_dom_raw_HTMLCollection__Z(0, 0, valores$1);
          if ($m_Ljogo_Tabuleiro$().fimJogo__Z()) {
            var painelFimJogo = $m_Ljogo_Tabuleiro$().corpo$1.getElementById("painelFimJogo");
            painelFimJogo.style = "display: block;";
            var lblPontuacao = $m_Ljogo_Tabuleiro$().corpo$1.getElementById("lblPontuacao");
            lblPontuacao.textContent = ("Sua pontua\u00e7\u00e3o foi: " + $m_Ljogo_Tabuleiro$().pontuacao$1)
          }
        })
      })(this, valores)));
      if ((this.pontuacao$1 > this.recorde$1)) {
        this.recorde$1 = this.pontuacao$1;
        return (void 0)
      } else {
        return (void 0)
      }
    ...
    return this.preencheTab$1__p1__I__I__Lorg_scalajs_dom_raw_HTMLCollection__Z(0, 0, valores)
  }
});
$c_Ljogo_Tabuleiro$.prototype.for2$2__p1__I__I__Z = (function(j, i$2) {
  _for2: while (true) {
    var x1 = j;
    switch (x1) {
      default: {
        if ((x1 > this.DIM$1)) {
          return this.for1$2__p1__I__Z(((1 + i$2) | 0))
        } else if (this.existemSomas__I__I__Z(i$2, j)) {
          return false
        } else {
          j = ((1 + j) | 0);
          continue _for2
...
$c_Ljogo_Tabuleiro$.prototype.addProx__I__I__I__V = (function(i, j, valor) {
  _addProx: while (true) {
    if (this.aux1$1__p1__I__Z(0)) {
      if ((this.matriz$1.get(i).get(j) === 0)) {
        this.matriz$1.get(i).set(j, valor)
      } else {
        var temp$i = this.rand__I();
        var temp$j = this.rand__I();
        var temp$valor = this.next__I();
        i = temp$i;
        j = temp$j;
        valor = temp$valor;
        continue _addProx
...
$c_Ljogo_Tabuleiro$.prototype.aux2$1__p1__I__I__Z = (function(j, i$1) {
  _aux2: while (true) {
    var x1 = j;
    switch (x1) {
      default: {
        if ((x1 <= this.DIM$1)) {
          if ((this.matriz$1.get(i$1).get(j) === 0)) {
            return true
          } else {
            j = ((1 + j) | 0);
            continue _aux2
...
$c_Ljogo_Tabuleiro$.prototype.finalizar__V = (function() {
  var n1 = ((1 + this.DIM$1) | 0);
  var n2 = ((1 + this.DIM$1) | 0);
  var arr = $newArrayObject($d_I.getArrayOf().getArrayOf(), [n1]);
  var isEmpty$4 = (n1 <= 0);
  ...
  this.matriz$1 = arr;
  var painelFimJogo = this.corpo$1.getElementById("painelFimJogo");
  painelFimJogo.parentNode.removeChild(painelFimJogo);
  this.pontuacao$1 = 0;
  this.corpo$1.location.href = "http://localhost:63342/doismil/Menu.html?_ijt=saoon0ks5i9tp2352bd6ub89dn"
});
$c_Ljogo_Tabuleiro$.prototype.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement = (function(num) {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var jsx$3 = this$1.div__Lscalatags_JsDom$TypedTag();
  var array = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(("bloco" + num), $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("bloco", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$2 = jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var this$4 = $m_Lscalatags_JsDom$all$();
  var jsx$1 = this$4.label__Lscalatags_JsDom$TypedTag();
  var array$1 = [$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(("valor" + num), $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("valor", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var array$2 = [jsx$1.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1)).apply__sc_Seq__Lscalatags_JsDom$TypedTag($m_sci_Nil$())];
  var bloco = jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2)).render__Lorg_scalajs_dom_raw_Element();
  bloco.style = (("background-color: " + this.COR$undBLOCO$1) + ";");
  return bloco
});
$c_Ljogo_Tabuleiro$.prototype.movimento$unddireita__I__I__V = (function(x, y) {
  _movimento_direita: while (true) {
    if ((y >= 0)) {
      if ((this.matriz$1.get(x).get(y) !== 0)) {
        var newPos = this.avaliar$undmovimentoY$unddireita__I__I__T2(x, ((1 + y) | 0));
        var x$4 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
        if ((!((newPos !== null) && newPos.equals__O__Z(x$4)))) {
          this.matriz$1.get(newPos.$$und1$mcI$sp__I()).set(newPos.$$und2$mcI$sp__I(), this.matriz$1.get(x).get(y));
          this.matriz$1.get(x).set(y, 0)
        };
        if ((((1 + newPos.$$und2$mcI$sp__I()) | 0) <= this.DIM$1)) {
          this.soma__I__I__I__I__V(newPos.$$und1$mcI$sp__I(), newPos.$$und2$mcI$sp__I(), newPos.$$und1$mcI$sp__I(), ((1 + newPos.$$und2$mcI$sp__I()) | 0))
        }
      };
      y = (((-1) + y) | 0);
      continue _movimento_direita
    };
    break
  }
});
$c_Ljogo_Tabuleiro$.prototype.fimJogo__Z = (function() {
  return (this.for1$1__p1__I__Z(0) && this.for1$2__p1__I__Z(0))
});
$c_Ljogo_Tabuleiro$.prototype.atualizarJogo__I__V = (function(sentido) {
  this.atualizarValores__I__O(sentido);
  this.atualizarPontuacaoERecorde__V()
});
$c_Ljogo_Tabuleiro$.prototype.for1$1__p1__I__Z = (function(x) {
  switch (x) {
    default: {
      return ((x > this.DIM$1) || this.for2$1__p1__I__I__Z(0, x))
    }
  }
});
$c_Ljogo_Tabuleiro$.prototype.avaliar$undmovimentoX$undbaixo__I__I__T2 = (function(x, y) {
  if ((this.DIM$1 === x)) {
    return ((this.matriz$1.get(x).get(y) === 0) ? new $c_s_Tuple2$mcII$sp().init___I__I(x, y) : new $c_s_Tuple2$mcII$sp().init___I__I((((-1) + x) | 0), y))
  } else if ((this.matriz$1.get(x).get(y) === 0)) {
    var avMov = this.avaliar$undmovimentoX$undbaixo__I__I__T2(((1 + x) | 0), y);
    var x$4 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
    if ((!((avMov !== null) && avMov.equals__O__Z(x$4)))) {
      return avMov
    } else {
      return new $c_s_Tuple2$mcII$sp().init___I__I(x, y)
    }
  } else {
    return new $c_s_Tuple2$mcII$sp().init___I__I((((-1) + x) | 0), y)
  }
});
$c_Ljogo_Tabuleiro$.prototype.jogar__V = (function() {
  this.addProx__I__I__I__V(this.rand__I(), this.rand__I(), this.next__I());
  this.addProx__I__I__I__V(this.rand__I(), this.rand__I(), this.next__I());
  this.plano$undde$undfundo__Lorg_scalajs_dom_raw_Node();
  this.atualizarValores__I__O(48);
  this.mensagemPont__Lorg_scalajs_dom_raw_Node();
  this.mensagemRecorde__Lorg_scalajs_dom_raw_Node();
  this.mensagemFimJogo__Lorg_scalajs_dom_raw_Node()
});
$c_Ljogo_Tabuleiro$.prototype.for1$3__p1__I__AAI__AAI__Z = (function(i, matriz1$1, matriz2$1) {
  switch (i) {
    default: {
      return ((i > this.DIM$1) || this.for2$3__p1__I__AAI__AAI__I__Z(0, matriz1$1, matriz2$1, i))
    }
  }
});
$c_Ljogo_Tabuleiro$.prototype.existemSomas__I__I__Z = (function(x, y) {
  if (((((-1) + x) | 0) >= 0)) {
    if ((this.matriz$1.get((((-1) + x) | 0)).get(y) === this.matriz$1.get(x).get(y))) {
      return true
    }
  };
  if ((((1 + x) | 0) <= this.DIM$1)) {
  ...
  if ((((1 + y) | 0) <= this.DIM$1)) {
    if ((this.matriz$1.get(x).get(((1 + y) | 0)) === this.matriz$1.get(x).get(y))) {
      return true
    }
  };
  if (((((-1) + y) | 0) >= 0)) {
...
$c_Ljogo_Tabuleiro$.prototype.avaliar$undmovimentoX$undcima__I__I__T2 = (function(x, y) {
  if ((x === 0)) {
    return ((this.matriz$1.get(x).get(y) === 0) ? new $c_s_Tuple2$mcII$sp().init___I__I(x, y) : new $c_s_Tuple2$mcII$sp().init___I__I(((1 + x) | 0), y))
  } else if ((this.matriz$1.get(x).get(y) === 0)) {
    var avMov = this.avaliar$undmovimentoX$undcima__I__I__T2((((-1) + x) | 0), y);
    var x$4 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
    if ((!((avMov !== null) && avMov.equals__O__Z(x$4)))) {
      return avMov
    } else {
...
$c_Ljogo_Tabuleiro$.prototype.rand__I = (function() {
  var random = new $c_s_util_Random().init___();
  return random.self$1.nextInt__I__I(4)
});
$c_Ljogo_Tabuleiro$.prototype.plano$undde$undfundo__Lorg_scalajs_dom_raw_Node = (function() {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var pndFundo = this$1.div__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag($m_sci_Nil$()).render__Lorg_scalajs_dom_raw_Element();
  pndFundo.style = ("Background-color: " + this.COR$undPLANO$undDE$undFUNDO$1);
  pndFundo.className = "pndFundo";
  pndFundo.id = "pndFundo";
  var this$2 = $m_Lscalatags_JsDom$all$();
  var jsx$5 = this$2.div__Lscalatags_JsDom$TypedTag();
  var array = [$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("linhaBlocos", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  ...
  var e = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(1);
  var e$1 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$5, e).e$1;
  var jsx$3 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$6, e$1);
  var this$8 = $m_Lscalatags_JsDom$all$();
  var this$7 = $m_Lscalatags_JsDom$all$();
  var e$2 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(2);
  var e$3 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$7, e$2).e$1;
  ...
  var e$4 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(3);
  var e$5 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$9, e$4).e$1;
  var jsx$1 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$10, e$5);
  var this$12 = $m_Lscalatags_JsDom$all$();
  var this$11 = $m_Lscalatags_JsDom$all$();
  var e$6 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(4);
  var e$7 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$11, e$6).e$1;
  var array$1 = [jsx$3, jsx$2, jsx$1, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$12, e$7)];
  pndFundo.appendChild(jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1)).render__Lorg_scalajs_dom_raw_Element());
  var this$15 = $m_Lscalatags_JsDom$all$();
  var jsx$10 = this$15.div__Lscalatags_JsDom$TypedTag();
  var array$2 = [$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("linhaBlocos", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$9 = jsx$10.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2));
  var this$19 = $m_Lscalatags_JsDom$all$();
  var this$18 = $m_Lscalatags_JsDom$all$();
  var e$8 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(5);
  var e$9 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$18, e$8).e$1;
  var jsx$8 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$19, e$9);
  var this$21 = $m_Lscalatags_JsDom$all$();
  var this$20 = $m_Lscalatags_JsDom$all$();
  var e$10 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(6);
  var e$11 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$20, e$10).e$1;
  var jsx$7 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$21, e$11);
  var this$23 = $m_Lscalatags_JsDom$all$();
  var this$22 = $m_Lscalatags_JsDom$all$();
  var e$12 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(7);
  var e$13 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$22, e$12).e$1;
  var jsx$6 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$23, e$13);
  var this$25 = $m_Lscalatags_JsDom$all$();
  var this$24 = $m_Lscalatags_JsDom$all$();
  var e$14 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(8);
  var e$15 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$24, e$14).e$1;
  var array$3 = [jsx$8, jsx$7, jsx$6, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$25, e$15)];
  pndFundo.appendChild(jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3)).render__Lorg_scalajs_dom_raw_Element());
  var this$28 = $m_Lscalatags_JsDom$all$();
  var jsx$15 = this$28.div__Lscalatags_JsDom$TypedTag();
  var array$4 = [$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("linhaBlocos", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$14 = jsx$15.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$4));
  var this$32 = $m_Lscalatags_JsDom$all$();
  var this$31 = $m_Lscalatags_JsDom$all$();
  var e$16 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(9);
  var e$17 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$31, e$16).e$1;
  var jsx$13 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$32, e$17);
  var this$34 = $m_Lscalatags_JsDom$all$();
  var this$33 = $m_Lscalatags_JsDom$all$();
  var e$18 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(10);
  var e$19 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$33, e$18).e$1;
  var jsx$12 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$34, e$19);
  var this$36 = $m_Lscalatags_JsDom$all$();
  var this$35 = $m_Lscalatags_JsDom$all$();
  var e$20 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(11);
  var e$21 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$35, e$20).e$1;
  var jsx$11 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$36, e$21);
  var this$38 = $m_Lscalatags_JsDom$all$();
  var this$37 = $m_Lscalatags_JsDom$all$();
  var e$22 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(12);
  var e$23 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$37, e$22).e$1;
  var array$5 = [jsx$13, jsx$12, jsx$11, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$38, e$23)];
  pndFundo.appendChild(jsx$14.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$5)).render__Lorg_scalajs_dom_raw_Element());
  var this$41 = $m_Lscalatags_JsDom$all$();
  var jsx$20 = this$41.div__Lscalatags_JsDom$TypedTag();
  var array$6 = [$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("linhaBlocos", $m_Lscalatags_JsDom$all$().stringAttr$1)];
  var jsx$19 = jsx$20.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$6));
  var this$45 = $m_Lscalatags_JsDom$all$();
  var this$44 = $m_Lscalatags_JsDom$all$();
  var e$24 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(13);
  var e$25 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$44, e$24).e$1;
  var jsx$18 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$45, e$25);
  var this$47 = $m_Lscalatags_JsDom$all$();
  var this$46 = $m_Lscalatags_JsDom$all$();
  var e$26 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(14);
  var e$27 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$46, e$26).e$1;
  var jsx$17 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$47, e$27);
  var this$49 = $m_Lscalatags_JsDom$all$();
  var this$48 = $m_Lscalatags_JsDom$all$();
  var e$28 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(15);
  var e$29 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$48, e$28).e$1;
  var jsx$16 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$49, e$29);
  var this$51 = $m_Lscalatags_JsDom$all$();
  var this$50 = $m_Lscalatags_JsDom$all$();
  var e$30 = this.bloco$undvazio__I__Lorg_scalajs_dom_raw_HTMLDivElement(16);
  var e$31 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$50, e$30).e$1;
  var array$7 = [jsx$18, jsx$17, jsx$16, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$51, e$31)];
  pndFundo.appendChild(jsx$19.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$7)).render__Lorg_scalajs_dom_raw_Element());
  var jsx$21 = this.corpo$1.body;
  var this$54 = $m_Lscalatags_JsDom$all$();
  return jsx$21.appendChild(new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$54, pndFundo).e$1)
});
$c_Ljogo_Tabuleiro$.prototype.clona__AAI__AAI = (function(matriz) {
  var n1 = ((1 + this.DIM$1) | 0);
  var n2 = ((1 + this.DIM$1) | 0);
  var arr = $newArrayObject($d_I.getArrayOf().getArrayOf(), [n1]);
  var isEmpty$4 = (n1 <= 0);
  ...
  if ((!isEmpty$4$1)) {
    ...
    while (true) {
      var v1$1 = i$1;
      var end$1 = $m_Ljogo_Tabuleiro$().DIM$1;
      var isEmpty$4$2 = (end$1 < 0);
      if ((!isEmpty$4$2)) {
        var i$2 = 0;
        while (true) {
          var v1$2 = i$2;
          arr.get(v1$1).set(v1$2, matriz.get(v1$1).get(v1$2));
          if ((i$2 === end$1)) {
            break
          };
          i$2 = ((1 + i$2) | 0)
...
$c_Ljogo_Tabuleiro$.prototype.for2$1__p1__I__I__Z = (function(y, x$1) {
  _for2: while (true) {
    var x1 = y;
    switch (x1) {
      default: {
        if ((x1 > this.DIM$1)) {
          return this.for1$1__p1__I__Z(((1 + x$1) | 0))
        } else if ((this.matriz$1.get(x$1).get(y) === 0)) {
          return false
        } else {
          y = ((1 + y) | 0);
          continue _for2
...
$c_Ljogo_Tabuleiro$.prototype.for1$2__p1__I__Z = (function(i) {
  switch (i) {
    default: {
      return ((i > this.DIM$1) || this.for2$2__p1__I__I__Z(0, i))
    }
  }
});
$c_Ljogo_Tabuleiro$.prototype.reiniciar__O = (function() {
  var n1 = ((1 + this.DIM$1) | 0);
  var n2 = ((1 + this.DIM$1) | 0);
  var arr = $newArrayObject($d_I.getArrayOf().getArrayOf(), [n1]);
  var isEmpty$4 = (n1 <= 0);
  ...
  this.matriz$1 = arr;
  var painelFimJogo = this.corpo$1.getElementById("painelFimJogo");
  painelFimJogo.style = "display: none;";
  this.pontuacao$1 = 0;
  this.addProx__I__I__I__V(this.rand__I(), this.rand__I(), this.next__I());
  this.addProx__I__I__I__V(this.rand__I(), this.rand__I(), this.next__I());
  this.atualizarPontuacaoERecorde__V();
  return this.atualizarValores__I__O(48)
});
$c_Ljogo_Tabuleiro$.prototype.aux1$1__p1__I__Z = (function(i) {
  _aux1: while (true) {
    var x1 = i;
    switch (x1) {
      default: {
        if ((x1 <= this.DIM$1)) {
          if (this.aux2$1__p1__I__I__Z(0, i)) {
            return true
          } else {
            i = ((1 + i) | 0);
            continue _aux1
...
$c_Ljogo_Tabuleiro$.prototype.$$js$exported$meth$atualizarJogo__I__O = (function(sentido) {
  this.atualizarJogo__I__V(sentido)
});
$c_Ljogo_Tabuleiro$.prototype.$$js$exported$meth$finalizar__O = (function() {
  this.finalizar__V()
});
$c_Ljogo_Tabuleiro$.prototype.avaliar$undmovimentoY$undesquerda__I__I__T2 = (function(x, y) {
  if ((y === 0)) {
    return ((this.matriz$1.get(x).get(y) === 0) ? new $c_s_Tuple2$mcII$sp().init___I__I(x, 0) : new $c_s_Tuple2$mcII$sp().init___I__I(x, ((1 + y) | 0)))
  } else if ((this.matriz$1.get(x).get(y) === 0)) {
    var avMov = this.avaliar$undmovimentoY$undesquerda__I__I__T2(x, (((-1) + y) | 0));
    var x$5 = new $c_s_Tuple2$mcII$sp().init___I__I(x, y);
    if ((!((avMov !== null) && avMov.equals__O__Z(x$5)))) {
      return avMov
    } else {
...
$c_Ljogo_Tabuleiro$.prototype.atualizarJogo = (function(arg$1) {
  var prep0 = $uI(arg$1);
  return this.$$js$exported$meth$atualizarJogo__I__O(prep0)
});
$c_Ljogo_Tabuleiro$.prototype.finalizar = (function() {
  return this.$$js$exported$meth$finalizar__O()
});
$c_Ljogo_Tabuleiro$.prototype.reiniciar = (function() {
  return this.$$js$exported$meth$reiniciar__O()
});
$c_Ljogo_Tabuleiro$.prototype.jogar = (function() {
  return this.$$js$exported$meth$jogar__O()
});
var $d_Ljogo_Tabuleiro$ = new $TypeData().initClass({
  Ljogo_Tabuleiro$: 0
}, false, "jogo.Tabuleiro$", {
  Ljogo_Tabuleiro$: 1,
  O: 1
});
$c_Ljogo_Tabuleiro$.prototype.$classData = $d_Ljogo_Tabuleiro$;
var $n_Ljogo_Tabuleiro$ = (void 0);
function $m_Ljogo_Tabuleiro$() {
  if ((!$n_Ljogo_Tabuleiro$)) {
    $n_Ljogo_Tabuleiro$ = new $c_Ljogo_Tabuleiro$().init___()
  };
  return $n_Ljogo_Tabuleiro$
}
/** @constructor */
...
$c_Lscalatags_JsDom$all$.prototype.label$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
...
$c_Lscalatags_JsDom$all$.prototype.label__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (64 & b.lo$2);
  if ((lo === 0)) {
...
$e.jogo = ($e.jogo || {});
$e.jogo.Tabuleiro = $m_Ljogo_Tabuleiro$;
}).call(this);
//# sourceMappingURL=doismil-fastopt.js.map
